...
from model.chat_2VE import chat
...
def main():
    ...
    parser.add_argument("--prompt_zh", type=str, default="生成中文超声报告：", help='Chinese prompt for the first round')
    ...
    with torch.no_grad():
        while True:
            ...
            if not args.english:
                ...
                # image_path = 'data/Ultrasound_data/files2/229145_k.jpeg'
            else:
