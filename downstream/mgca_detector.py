...
from datasets.detection_dataset import (OBJCXRDetectionDataset,
                                             RSNADetectionDataset,
                                             BUSIDetectionDataset,
                                        DDTIDetectionDataset)
from datasets.detection_dataset import det_collate_fn
...
def cli_main():
    ...
    parser.add_argument("--ckpt_path", type=str,
                        default="/home/sutongkun/Pretrain_VLP_Project/New_Model/MGCA/data/ckpts/MGCA/35/epoch=45-step=7405.ckpt")
    parser.add_argument("--dataset", type=str,
                        default="rsna", help="rsna or object_cxr or busi or ddti")
    ...
    if args.dataset == "rsna":
        ...
        datamodule = DataModule(BUSIDetectionDataset, det_collate_fn, DetectionDataTransforms,
                                args.data_pct, args.batch_size, args.num_workers)
