...
from downstream.datasets.segmentation_dataset import (RSNASegmentDataset,
                                                ...
                                                BUSISegmentDataset,
                                           DDTISegmentDataset)
from downstream.datasets.segmentation_dataset import seg_collate_fn
...
def cli_main():
    ...
    parser.add_argument("--ckpt_path", type=str,
                        default="/home/sutongkun/VLPv2/VisualGLM/VisualGLM-6B/checkpoints/vit/12.pth")
    ...
    if args.base_model == "vit":
        ...
        args.seg_model.encoder_2d.bert_model = model  # 将MGCA的vit作为分割模型的vit
    ...
    ckpt_dir = os.path.join(
        BASE_DIR, f"../checkpoints/segmentation/{extension}")
