...
class TextGenerationPipeline(Pipeline):
    ...
    def __call__(self, text_inputs, imgs, **kwargs):
        """
        ...
        """
        return super().__call__(text_inputs, imgs, **kwargs)
    ...
    def _forward(self, model_inputs, img0, img1, **generate_kwargs):
        ...
        # BS x SL
        generated_sequence = self.model.generate(input_ids=input_ids, attention_mask=attention_mask, img0=img0,
                                                 img1=img1, **generate_kwargs)
