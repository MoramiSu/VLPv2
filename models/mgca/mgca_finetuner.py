...
from datasets.classification_dataset import (CheXpertImageDataset,
                                                  COVIDXImageDataset,
                                                  RSNAImageDataset,
                                                  BUSIImageDataset,
                                                  AUIDTImageDataset)
...
def cli_main():
    ...
    parser.add_argument("--path", type=str,
                        default="/home/sutongkun/VLPv2/MGCA/data/ckpts/MGCA/2023_09_03_23_54_16/epoch=21-step=5873.ckpt")
